...
Intento 1: Credenciales Predecibles (A Mano)
...
Contraseñas probadas: mario, trust, password, admin, docker, pass.
❌ Resultado: Ninguna credencial por defecto otorgó acceso.



Intento 2: Fuerza Bruta con Hydra (Éxito)
...
Escaneo limpio de puertos con optimización de paquetes.

Fuzzing web evadiendo de forma efectiva las respuestas comodín.

Extracción de usuarios válidos a través de la lógica y descuidos del sitio web.

Fuerza bruta exitosa orientada a servicios de acceso seguro (SSH).

Enumeración local precisa y abuso de configuraciones desatendidas en Sudo (GTFOBins).
